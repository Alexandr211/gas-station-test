...
<h3> Результат:
Хранимая процедура реализована в таблице ticket1 (дамп базы - taxi.sql), тестовый вызов процедуры proc1 можно сделать в методе actionTest (web/index.php?r=site%2Ftest).</h3>
<br>
<br>
